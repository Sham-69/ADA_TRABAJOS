...
// Escribe un programa que le pida al usuario ingresar un color del semáforo: rojo, amarillo o verde. Dependiendo del color 
...
let color = prompt('Ingrese un color del semaforo: ').toLocaleLowerCase();
